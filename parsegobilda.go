...
var gobildaTarget = spiderTarget{
	"gobilda.txt",
	"15XT3v9O0VOmyxqXrgR8tWDyb_CRLQT5-xPfWPdbx4RM",
	[]string{
...
var servocityTarget = spiderTarget{
	"servocity.txt",
	"15Mm-Thdcpl5fVPs3vnyFUXWthuaV1tacXPJ7xQuoB8A",
	[]string{"https://www.servocity.com/structure/",
...
func checkServocityMatch(partData *PartData) {
...
func parseServocityPage(ctx *fetchbot.Context, doc *goquery.Document) {
	mu.Lock()
	url := doc.Url.String()
	found := false
